...
//   /* ==========================================================
//      ✅ STRIPS SCROLL ANIMATION
//      ✅ DOWN scroll => strips UP
//      ✅ UP scroll   => strips DOWN
//      ✅ ONLY for Entrepreneurship section
//      ========================================================== */
//   useEffect(() => {
...
//                       startup founders across Australasia, securing your first
//                       $1m remains a big challenge. Despite being able to access
//                       support from a thriving Australasian startup ecosystem,
...
//                 {/* ✅ NEW: "WE ONLY WIN WHEN YOU WIN" SECTION ABOVE FOOTER */}
...
/*Capital Images*/
import capitalInfoImg from "./assets/capital-info.png";
import arrowImg from "./assets/arrow.png";
import CapitalContactPage from "./pages/CapitalContactPage";

import capitalSec2Img from "./assets/capital-info.png";
import capitalSec3Img from "./assets/capital-info.png";
import capitalSec4Img from "./assets/capital-info.png";
...
<section className="capital-extra-section">
 ...
 <h2 className="capital-info-title">A track record of success</h2>
      <p className="capital-extra-text">
        Our venture studio model has been baked into Paloma since our inception
        in 2016. We have consistently invested in venture creation since day
        zero. We have a strong portfolio of ventures with a remarkable success
        rate. Paloma Capital sits on top of that strong foundation.
      </p>
    </div>
...
<section className="capital-extra-section">
 ...
 <h2 className="capital-info-title">Co-investment rights</h2>
      <p className="capital-extra-text">
        Paloma earns sweat equity in the companies that we help build through our
        venture studio. The preemptive rights associated with this equity are
        made available to Paloma Capital at no cost - a unique benefit of
